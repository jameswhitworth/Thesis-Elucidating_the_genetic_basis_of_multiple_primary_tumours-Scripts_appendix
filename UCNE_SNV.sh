...
for i in `cat chromosome_files.txt`; do
  bcftools view -R UCNE.bed -e 'FILTER!="PASS"' -o ${i}_filtered.vcf -O v /rds/project/who1000/rds-who1000-wgs10k/WGS10K/data/release/20170614-A/merged-vcf/no_hgmd/${i}.vcf.gz
done
...
bcftools filter -e 'FMT/DP<10 || FMT/GQ<30 || (FMT/AD[1]/(FMT/AD[0] + FMT/AD[1]) <0.3) || (FMT/AD[1]/(FMT/AD[0] + FMT/AD[1] + FMT/AD[2]) <0.3) || (FMT/AD[2]/(FMT/AD[0] + FMT/AD[1] + FMT/AD[2]) <0.3)' -S . -o UCNE_merged_filtered.vcf.gz -O z merged.vcf.gz
...
/home/jww39/ensembl-vep/filter_vep -i UCNE_merged_filtered.vcf -o VEP_filtered_UCNE_merged.vcf -filter "(
...
sed -i 's/#CHROM/CHROM/g' VEP_filtered_UCNE_merged.vcf
sed '/^#/ d' VEP_filtered_UCNE_merged.vcf > VEP_filtered_UCNE_merged_without_header.vcf
mv VEP_filtered_UCNE_merged.vcf VEP_filtered_UCNE_merged_with_header.vcf
mv VEP_filtered_UCNE_merged_without_header.vcf  VEP_filtered_UCNE_merged.vcf
...
MPT_BRIDGE <- read.delim("VEP_filtered_UCNE_merged.vcf", header = T)
...
##Output results
write.csv(MPT_BRIDGE_final_sig, paste("/home/jww39/non_coding/UCNE_enhancers_promoters/with_internal_af_filter/UCNE_only/", tumour_query,".csv", sep = "")) 
write.csv(variants_per_gene_table_sig, paste("/home/jww39/non_coding/UCNE_enhancers_promoters/with_internal_af_filter/UCNE_only/", tumour_query,"_variants_per_gene_table.csv", sep = "")) 

write.csv(MPT_BRIDGE_final, paste("/home/jww39/non_coding/UCNE_enhancers_promoters/with_internal_af_filter/UCNE_only/", tumour_query,"_all.csv", sep = "")) 
write.csv(variants_per_gene_table, paste("/home/jww39/non_coding/UCNE_enhancers_promoters/with_internal_af_filter/UCNE_only/", tumour_query,"_variants_per_gene_table_all.csv", sep = "")) 
