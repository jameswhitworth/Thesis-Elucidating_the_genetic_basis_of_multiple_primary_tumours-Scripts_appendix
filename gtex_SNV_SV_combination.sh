...
#Rscript gtex_SNV_SV_combination.R ALL XXX XXX XXX XXX
#Rscript gtex_SNV_SV_combination.R 1FROM2 Phaeochromoctoma ACC XXX XXX
#Rscript gtex_SNV_SV_combination.R 1FROM2 CNS CNSNervesheath XXX XXX
#Rscript gtex_SNV_SV_combination.R SINGLE Breast XXX XXX XXX
#Rscript gtex_SNV_SV_combination.R SINGLE Haemlymphoid XXX XXX XXX
#Rscript gtex_SNV_SV_combination.R SINGLE Colorectal XXX XXX XXX
#Rscript gtex_SNV_SV_combination.R SINGLE Oesophagus XXX XXX XXX
#Rscript gtex_SNV_SV_combination.R SINGLE Cardiacmyxoma XXX XXX XXX
#Rscript gtex_SNV_SV_combination.R SINGLE Lung XXX XXX XXX
#Rscript gtex_SNV_SV_combination.R SINGLE Salivarygland XXX XXX XXX
#Rscript gtex_SNV_SV_combination.R SINGLE Connectivetissuesofttissuesarcoma XXX XXX XXX
#Rscript gtex_SNV_SV_combination.R 1FROM3 PNSNervesheathbenign PNSNervesheath Nervesheathbenign XXX
#Rscript gtex_SNV_SV_combination.R SINGLE Ovary XXX XXX XXX
#Rscript gtex_SNV_SV_combination.R SINGLE Pancreas XXX XXX XXX
#Rscript gtex_SNV_SV_combination.R SINGLE Pituitary XXX XXX XXX
#Rscript gtex_SNV_SV_combination.R SINGLE Prostate XXX XXX XXX
#Rscript gtex_SNV_SV_combination.R 1FROM3 NMSC Melanoma Skinbenign XXX
#Rscript gtex_SNV_SV_combination.R 1FROM2 Smallbowel GINET XXX XXX
#Rscript gtex_SNV_SV_combination.R SINGLE Gastric XXX XXX XXX
#Rscript gtex_SNV_SV_combination.R SINGLE Testicular XXX XXX XXX
#Rscript gtex_SNV_SV_combination.R SINGLE Thyroid XXX XXX XXX
#Rscript gtex_SNV_SV_combination.R 1FROM3 Endometrial Uterineleiomyoma Uterinesarcoma XXX
#Rscript gtex_SNV_SV_combination.R 1FROM4 Haemlymphoid Haemmyeloid Haempolycythaemia Haemthrombocythaemia
############################################################################################################
...
##Read in gene list
gene_list <- read.delim("gtex_gene_list.txt", header = F)
...
SNV_SV_table <- SNV_SV_table[which(SNV_SV_table$tumour_col == paste(args[1],args[2],args[3],args[4],args[5],sep = "")),]
...
#Convert row names to Illumina ID as in VCF
...
gene_list_col <- rep(paste(args[1],args[2],args[3],args[4],args[5],sep = ""), nrow(gene_list))
...
##Output results
write.csv(cases_controls_count, paste("/home/jww39/non_coding/gtex/with_internal_af_filter/SNV_SV/", 
                                      paste(args[1],args[2],args[3],args[4],args[5],sep = ""),
                                      "_SNV_SV_table_all.csv", sep = "")) 

write.csv(cases_controls_count_sig, paste("/home/jww39/non_coding/gtex/with_internal_af_filter/SNV_SV/", 
                                          paste(args[1],args[2],args[3],args[4],args[5],sep = "")
